...
#SBATCH --mem=50G		        # RAM memory to reserve
...
#SBATCH --output=logfile_extraction-%J.dat   # important for debugging etc!! name individually
...
python ../src/logfile_etl/logfile_etl.py extract-features
